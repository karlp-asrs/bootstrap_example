...
Now let's calculate the probability that the annual expected return is greater than zero.

```{r}
pnorm(0,ann_mu,ann_sd)
```

We see a highly significant result that the returns of this strategy are positive in the long run.

But what about in any one year?  That's a different problem.  It's more like drawing just 12 balls from the urn of possible monthly returns.  Let's bootstrap that statistic and see what it tells us.
